...
const expressAppIntializer = async (app) => {
    ...
    await connect_1.default.initialize()
        ...
        .catch((err) => {
        exports.expressLogger.error(`Error While Initalizing Database . Error` + err);
        process.exit(0);
    });
    await connect_1.default.runMigrations().catch((err) => {
        exports.expressLogger.error(`Error While Migration Database Error:`, err);
        process.exit(0);
    });
